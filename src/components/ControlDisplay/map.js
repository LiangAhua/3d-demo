...
import * as ToolButton from "../toolButton"
...
const button = ToolButton.onMounted(map)
export function toolButton(val) {
  if(val) {
    console.log('addControl', val)
    map.addControl(button)
  } else {
    console.log('removeControl', val)
    map.removeControl(button)
  }
  // val ? map.addControl(button) : map.removeControl(button, true)
}
